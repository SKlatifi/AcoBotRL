...
%     id = '600umsolder_20161801_tracktest'; % Identifier of the experiment run
    ...
    % Under water
    mkdir([datapath 'TracktestUW_2018_20_1_m3_extend\']);
    datafile = [datapath 'TracktestUW_2018_20_1_m3_extend\' id '.mat'];
    load('D:\Projects\Acobot\AcoLabControl\TempData\modeInfoUW2018_20_1_m3_extend.mat');   
    ...
    for i = 1:N
        beforefile = sprintf('%sTracktestUW_2018_20_1_m3_extend\\%s_%06d_%.0f_%.0f_%.3f_in.jpg',datapath,id,i,modeInfo.freq(exps(i)),modeInfo.duration(exps(i)),modeInfo.amp(exps(i)));       
        afterfile = sprintf('%sTracktestUW_2018_20_1_m3_extend\\%s_%06d_%.0f_%.0f_%.3f_out.jpg',datapath,id,i,modeInfo.freq(exps(i)),modeInfo.duration(exps(i)),modeInfo.amp(exps(i)));
