...
datafile = ['../../TempData/Resistor_NC_' datestr(now,'yymmdd_HHMMSS') '.txt'];
...
modes.durations = modes.durations * 1;

%t = {[0.3 0.3;0.1 0.3;0.1 0.5;0.3 0.5;0.3 0.7;0.1 0.7],[0.7 0.3;0.5 0.3;0.5 0.7;0.7 0.7],[0.9 0.3;0.9 0.7]};
t = {};
t{1} = [0.2 0.65; 0.2 0.35; 0.4 0.65; 0.4 0.35];
t{2} = [0.9 0.35;0.7 0.35;0.7 0.45;0.7 0.55;0.7 0.65;0.9 0.65];
